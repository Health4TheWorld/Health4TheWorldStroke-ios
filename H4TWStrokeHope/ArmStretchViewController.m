...
@interface ArmStretchViewController ()
...
@implementation ArmStretchViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = [NSLocalizedString(@"Stretching.shoulderStretch", nil) uppercaseString];
