...
#define VIDEO_BT_SITTING_3572 @"IMG_3572.mp4"//MM
...
#define VIDEO_ARM_LEVEL2_1 @"IMG_3561.mp4"
#define VIDEO_ARM_LEVEL2_2 @"IMG_3562.mp4"
#define VIDEO_ARM_LEVEL2_3 @"IMG_3563.mp4"
#define VIDEO_ARM_LEVEL2_4 @"IMG_3565.mp4"
...
#define VIDEO_ARM_LEVEL3_6 @"IMG_3567.mp4"
#define VIDEO_ARM_LEVEL3_7 @"IMG_3566.mp4"
...
#define STRETCHING_INTRUCTIONS_TITLE NSLocalizedString(@"Stretching.instructions.title", nil)
#define STRETCHING_INSTRUCTIONS_BULLETS @[NSLocalizedString(@"Stretching.instructions.bullet1", nil), NSLocalizedString(@"Stretching.instructions.bullet2", nil), NSLocalizedString(@"Stretching.instructions.bullet3", nil), NSLocalizedString(@"Stretching.instructions.bullet4", nil)]
...
#define STRETCHING_END NSLocalizedString(@"Exercises.stretching.end", nil)
#define EXERCISES_GENERAL_INSTRUCTIONS_TITLE NSLocalizedString(@"Exercises.generalInstructions", nil)
#define EXERCISES_GENERAL_INSTRUCTIONS_BULLETS @[NSLocalizedString(@"Exercises.generalInstructionsBullet1",nil), NSLocalizedString(@"Exercises.generalInstructionsBullet2",nil), NSLocalizedString(@"Exercises.generalInstructionsBullet3",nil), NSLocalizedString(@"Exercises.generalInstructionsBullet4",nil), NSLocalizedString(@"Exercises.generalInstructionsBullet5",nil)]
...
/* CHATBOT SECTION */
#define NO_BUTTON NSLocalizedString(@"Chatbot.no", nil)
#define YES_BUTTON NSLocalizedString(@"Chatbot.yes", nil)
#define LONELY_BUTTON1 NSLocalizedString(@"Chatbot.lonelybutton1", nil)
#define LONELY_BUTTON2 NSLocalizedString(@"Chatbot.lonelybutton2", nil)
#define LONELY_BUTTON3 NSLocalizedString(@"Chatbot.lonelybutton3", nil)
#define LONELY_BUTTON4 NSLocalizedString(@"Chatbot.lonelybutton4", nil)
#define LONELY_BUTTON5 NSLocalizedString(@"Chatbot.lonelybutton5", nil)
#define LONELY_OPTIONS_TEXT NSLocalizedString(@"Chatbot.lonelyoptions", nil)
#define EXIT_BUTTON NSLocalizedString(@"Chatbot.exit", nil)
#define ICON1_MESSAGE NSLocalizedString(@"Chatbot.icon1message", nil)
#define FEELING_BUTTON1 NSLocalizedString(@"Chatbot.feelingbutton1", nil)
#define FEELING_BUTTON2 NSLocalizedString(@"Chatbot.feelingbutton2", nil)
#define FEELING_BUTTON3 NSLocalizedString(@"Chatbot.feelingbutton3", nil)
#define FEELING_BUTTON4 NSLocalizedString(@"Chatbot.feelingbutton4", nil)
#define FEELING_BUTTON5 NSLocalizedString(@"Chatbot.feelingbutton5", nil)
#define FEELING_BUTTON6 NSLocalizedString(@"Chatbot.feelingbutton6", nil)
#define FEELING_MESSAGE1 NSLocalizedString(@"Chatbot.feelingmessage1", nil)
#define FEELING_MESSAGE2 NSLocalizedString(@"Chatbot.feelingmessage2", nil)
#define FEELING_MESSAGE3 NSLocalizedString(@"Chatbot.feelingmessage3", nil)
#define FEELING_MESSAGE4 NSLocalizedString(@"Chatbot.feelingmessage4", nil)
#define FEELING_MESSAGE5 NSLocalizedString(@"Chatbot.feelingmessage5", nil)
#define FEELING_MESSAGE6 NSLocalizedString(@"Chatbot.feelingmessage6", nil)
