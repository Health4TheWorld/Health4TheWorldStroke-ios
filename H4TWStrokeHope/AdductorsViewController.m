...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = [NSLocalizedString(@"Stretching.legStretch", nil) uppercaseString];
...
- (void)setUpView {
    ...
    UIImage *image = [UIImage imageNamed: STRETCHING_LEG_STRETCH_1];
...
- (void)addImageView:(UIImage *)image {
    ...
    self.height = width;
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.currentY, width, self.height)];
