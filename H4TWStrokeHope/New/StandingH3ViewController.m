...
- (void)setUpView {
    ...
    HomeButton *h1 = [[HomeButton alloc] initWithText:@"3575" withFrame:CGRectMake(SPACE_BETWEEN_CELLS, startingY, cellWidth, cellHeight)];
    ...
    HomeButton *h2 = [[HomeButton alloc] initWithText:@"3775" withFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width/ 2) + (SPACE_BETWEEN_CELLS / 2), startingY, cellWidth, cellHeight)];
    [h2 addImageCentered:[UIImage imageNamed:BT_Standing_img_3575]];
    ...
    HomeButton *h3 = [[HomeButton alloc] initWithText:@"3576" withFrame:CGRectMake(SPACE_BETWEEN_CELLS, startingY, cellWidth, cellHeight)];
